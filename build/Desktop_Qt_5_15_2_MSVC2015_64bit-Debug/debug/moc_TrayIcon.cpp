...
QT_MOC_LITERAL(1, 9, 21), // "showSettingsRequested"
QT_MOC_LITERAL(2, 31, 0), // ""
QT_MOC_LITERAL(3, 32, 13), // "quitRequested"
QT_MOC_LITERAL(4, 46, 13), // "updateToolTip"
QT_MOC_LITERAL(5, 60, 4), // "text"
QT_MOC_LITERAL(6, 65, 11), // "onActivated"
QT_MOC_LITERAL(7, 77, 33), // "QSystemTrayIcon::ActivationRe..."
QT_MOC_LITERAL(8, 111, 6) // "reason"

    },
    "TrayIcon\0showSettingsRequested\0\0"
    "quitRequested\0updateToolTip\0text\0"
...
void TrayIcon::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->showSettingsRequested(); break;
        case 1: _t->quitRequested(); break;
        case 2: _t->updateToolTip((*reinterpret_cast< const QString(*)>(_a[1]))); break;
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&TrayIcon::showSettingsRequested)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (TrayIcon::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&TrayIcon::quitRequested)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void TrayIcon::showSettingsRequested()
{
